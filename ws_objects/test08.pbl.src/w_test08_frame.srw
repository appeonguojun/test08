$PBExportHeader$w_test08_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_test08_frame from window
end type
type mdi_1 from mdiclient within w_test08_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_test08_frame"
...
global w_test08_frame w_test08_frame

type variables
n_test08_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_test08_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_test08_sheet1", "w_test08_sheet2", "w_test08_sheet3" }
...
inv_sheetmgt = Create n_test08_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_test08_frame.create
if this.MenuName = "m_test08_frame" then this.MenuID = create m_test08_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_test08_frame.destroy
